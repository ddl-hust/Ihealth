...
RFMYSQL::RFMYSQL() : _db(NULL), connected(false) {}

RFMYSQL::~RFMYSQL() { Close(); }
...
RFMYSQLStmt::RFMYSQLStmt() : _res(NULL), _row(NULL) {}

RFMYSQLStmt::RFMYSQLStmt(RFMYSQL &db, const char *sql) { Prepare(db, sql); }

RFMYSQLStmt::~RFMYSQLStmt() { Finalize(); }
