...
void RFPatientsTrainInfo::setDoctorID(int id) { m_doctorid = id; }

void RFPatientsTrainInfo::setHospitalID(int id) { m_hospitalid = id; }

void RFPatientsTrainInfo::setCurrentPage(int page) { m_current_page = page; }

int RFPatientsTrainInfo::pageElementNum(int page) { return (m_patienttraininfos.size() - page * PATIENT_TRAIN_PAGE_NUMBER) % PATIENT_TRAIN_PAGE_NUMBER; }
